...
const routes: Routes = [
  ...
  {path: '', pathMatch: 'full', redirectTo: 'home/es'}, // Ruta que lleva al componente home por defecto si no coincide con ninguna anterior
  {path: '**', pathMatch: 'full', redirectTo: 'home/es'} // Ruta que lleva al componente home si no coincide con ninguna anterior
];
